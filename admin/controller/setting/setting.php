...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
      ...
      $this->request->post['config_address'] = $this->request->post['config_langdata'][$front_language_id]['comment'];
		...
		//roma added by
		if (isset($this->request->post['config_disclaimer'])) {
			$data['config_disclaimer'] = $this->request->post['config_disclaimer'];
		} else {
			$data['config_disclaimer'] = $this->config->get('config_disclaimer');
		}
