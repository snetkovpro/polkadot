        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="Предупреждение для красок и спреев">Предупреждение для краски и спреев</span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($config_disclaimer) { ?>
                    <input type="radio" name="config_disclaimer" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="config_disclaimer" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$config_disclaimer) { ?>
                    <input type="radio" name="config_disclaimer" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="config_disclaimer" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
