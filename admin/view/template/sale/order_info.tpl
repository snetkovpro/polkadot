        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              <?php if ($shipping_method) { ?>
              <td class="text-left"><?php echo $text_shipping_address; ?>
                <?php } ?></td>
            </tr>
          </thead>
          <tbody>
                        ...
                        <tr>
                             <td>
                                 <?php foreach ($account_custom_fields as $custom_field) { ?>
                                    <?php if (in_array($custom_field['name'], $address_fields)) { ?>
                                     <?php echo $custom_field['value']; ?> <br>
                                     <?php $address_fields = array_flip($address_fields); unset($address_fields[$custom_field['name']]); $address_fields = array_flip($address_fields); } ?>
                                <?php } ?>
                            </td>
                        </tr>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <?php foreach ($coupon_product as $key => $value) { ?>
                <?php   if ($product['product_id'] == $value) { ?>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="tab-additional">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <?php foreach ($account_custom_fields as $custom_field) { ?>
                    <?php if (in_array($custom_field['name'], $andrew_fields)) { ?>
                        <tr>
                          <td><?php echo $custom_field['name']; ?></td>
                          <td><?php echo $custom_field['value']; ?></td>
                        </tr>
                    <?php $andrew_fields = array_flip($andrew_fields); unset($andrew_fields[$custom_field['name']]); $andrew_fields = array_flip($andrew_fields); } ?>
                <?php } ?>
              </tbody>
            </table>
            <?php } ?>
