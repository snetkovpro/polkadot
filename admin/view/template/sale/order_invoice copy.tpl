      ...
      <tbody>
        <tr>
          <td style="width: 50%;"><address>
            ...
            <b>Покупатель:</b> <?php echo $name; ?><br />
    ...
    <table class="table table-bordered">
      <thead>
        <tr>
          ...
          <td style="width: 100%;"><b><?php echo('Адрес'); ?></b></td>
        </tr>
      </thead>
      <tbody>
        <tr>
          ...
          <td><address>
            ...
            <?php foreach ($account_custom_fields as $field) { ?>
            <?php     if ($field['name'] == 'Почтовый индекс') { echo $field['value']; ?>
            <br/>
            <?php } ?>
            <?php     if ($field['name'] == 'Регион/Область') { echo $field['value']; ?>
            <br/>
            <?php } ?>
            <?php     if ($field['name'] == 'Город') { echo $field['value']; ?>
            <br/>
            <?php } ?>
            <?php     if ($field['name'] == 'Улица, номер дома и квартиры') { echo $field['value']; ?>
            <br/>
            <?php } ?>
            <?php } ?>
            </address></td>
