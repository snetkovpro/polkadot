  ...
  <div class="container-fluid">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-list"></i> Список полных корзин </h3>
      </div>
          ...
          <div class="table-responsive">
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                 ...
                 <?php foreach($actual_cart as $this_cart){ ?>
                    
                
                    <tr>
                      
                      <td><?php echo $this_cart['customer']; ?></td>
                      <td><?php echo $this_cart['date']; ?></td>
                      <td><a href="<?php echo $this_cart['view']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn btn-info"><i class="fa fa-eye"></i></a></td>
