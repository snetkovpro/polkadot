            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'pd.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left hidden"><?php if ($sort == 'p.model') { ?>
                  ...
                  <td class="text-right"><?php if ($sort == 'p.price') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right">
                    <?php echo $column_wholesale; ?>
                  </td>
                  <td class="text-right">
                    <?php echo $column_wholesale_percent; ?>
                  </td>
                  <td class="text-right">
                    <?php echo $column_price_percent; ?>
                  </td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <?php echo $product['percent_opt']; ?>
                  </td>
                  <td class="text-right">
                    <?php echo($product['percent_roz']); ?>
                  </td>
                  <td class="text-left">
                    <?php foreach ($categories as $category) { ?>
