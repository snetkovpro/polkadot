            ...
            <div class="tab-pane" id="tab-data">
              <div class="form-group">
                ...
                <table id="pack-table">
                  ...
                  <tr>
                    <th>Упаковка</th>
                    <td><input type="text" id="ipack" value="<?php echo $pack; ?>"></td>
                    <td><input type="text" id="ipack-retail" value="<?php echo $pack_retail; ?>"></td>
                  </tr>
                  <tr>
                    <th>Минимум</th>
                    <td><input type="text" id="iminimum" value="<?php echo $minimums['wholesale'];?>"></td>
                    <td><input type="text" id="iminimum-retail" value="<?php echo $minimums['retail'];?>"></td>
                  </tr>
                  <tr>
                    <th>Цена</th>
                    <td><input type="text" id="wholesale" value="<?php echo $prices['wholesale'];?>"></td>
                    <td><input type="text" id="retail" value="<?php echo $prices['retail'];?>"></td>
                  </tr>
                  <tr>
                    <th>Скидка</th>
                    <?php if (empty($prices['wholesale_discount'])) { ?>
                          <td><input id="wholesale_discount" type="text" value="0"></td>
                    <?php } else { ?>
                          <td><input id="wholesale_discount" type="text" value="<?php echo $prices['wholesale_discount'];?>"></td>
                    <?php } ?>
                    <?php if (empty($prices['retail_discount'])) { ?>
                          <td><input id="retail_discount" type="text" value="0"></td>
                    <?php } else { ?>
                          <td><input id="retail_discount" type="text" value="<?php echo $prices['retail_discount'];?>"></td>
                    <?php } ?>
                  </tr>
                  <tr>
                    <td colspan="3">
                      <button class="btn btn-primary" id="prices-btn">Изменить параметры</button>
                    </td>
                  </tr>
                </table>
              ...
              <!-- Совместимость с контроллером #roma -->
              ...
              <script type="text/javascript">
                  $('#pack-button').on('click', function(){
                      if($('#input-pack').is(":checked")){
                             $.ajax({
                                url: 'index.php?route=catalog/product/setPack&token=<?php echo $token; ?>&product_id=<?php echo $product_id ?>&pack=' + $("#quantity-pack").val(),
                             ...
                             $.ajax({
                                url: 'index.php?route=catalog/product/deletePack&token=<?php echo $token; ?>&product_id=<?php echo $product_id ?>',
                                success: function(htmlText) {
                                    alert(htmlText);
                                },
                                error: function(xhr, ajaxOptions, thrownError) {
                  ...
                  $('#pack-button-retail').on('click', function(){
                      if($('#input-pack-retail').is(":checked")){
                             $.ajax({
                                url: 'index.php?route=catalog/product/setPack&token=<?php echo $token; ?>&product_id=<?php echo $product_id ?>&pack=' + $("#quantity-pack-retail").val() + '&retail=1',
                                success: function(htmlText) {
                                    alert(htmlText);
                                },
                                error: function(xhr, ajaxOptions, thrownError) {
                             ...
                             $.ajax({
                                url: 'index.php?route=catalog/product/deletePack&token=<?php echo $token; ?>&product_id=<?php echo $product_id ?>&retail=1',
                                success: function(htmlText) {
                                    alert(htmlText);
                                },
                                error: function(xhr, ajaxOptions, thrownError) {
              ...
              <script type="text/javascript">
                  $('#input-pack').change( function(){
                     if($('#input-pack').is(":checked")){
                         $("label[for='input-price']").html("Цена за упаковку");
                         $("input[name='price']").parent().after("<label class='col-sm-1 control-label' for='packprice'>Цена ед. товара</label><div class='col-sm-1'><span id='packprice'></span></div>");
                         $("label[for='input-quantity']").html("Количество упаковок");
                     } else {
                         $("label[for='input-price']").html("Цена");
                         $("label[for='input-quantity']").html("Количество");
                         $("label[for='packprice']").remove();
                         $('#packprice').unwrap();
                         $('#packprice').remove();
                     }
                  });
             ...
             <script type="text/javascript">
                 $('#minimum-save').on('click', function(){
                     $.ajax({
                         url: 'index.php?route=catalog/product/setMinimums&token=<?php echo $token; ?>&product_id=<?php echo $product_id ?>&customer_id=' + $("#input-customers").val() + '&min_quantity=' + $('#fminimum').val(), 
                         success: function(htmlText) {
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="guest_status">Включить для гостей?</label>
                <div class="col-sm-4">
                    <?php if ($guest_status) { ?>
                      <input type="checkbox" name="guest_status" checked>
                    <?php } else { ?>
                      <input type="checkbox" name="guest_status">
                    <?php } ?>
                </div>
              </div>
              <div class="form-group">
...
<script type="text/javascript">
                  ...
                  $('#prices-btn').on('click', function(){
                    $.ajax({
                                url: 'index.php?route=catalog/product/setEverything&token=<?php echo $token; ?>&product_id=<?php echo $product_id ?>&pack=' + $("#ipack").val() + '&pack_retail=' + $("#ipack-retail").val() + '&min=' + $("#iminimum").val() + '&min_retail=' + $("#iminimum-retail").val() + '&retail=' + $("#retail").val() + '&wholesale=' + $("#wholesale").val() + '&retail_discount=' + $("#retail_discount").val() + '&wholesale_discount=' + $("#wholesale_discount").val(),
