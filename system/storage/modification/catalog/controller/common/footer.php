...
class ControllerCommonFooter extends Controller {
	public function index() {
		...
		$data['powerede'] = sprintf($this->language->get('text_powerede'), $this->config->get('config_name'), date('Y', time()));
		$data['poweredc'] = sprintf($this->language->get('text_poweredc'), $this->config->get('config_name'), date('Y', time()));
		// Whos Online
