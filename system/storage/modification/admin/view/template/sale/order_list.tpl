    ...
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
			        <a href="<?php echo $invoice_kassa; ?>" data-toggle="tooltip" title="<?php echo $button_invoice_kassa; ?>" class="btn btn-warning"><i class="fa fa-envelope"></i></a></div>
      ...
      <div class="panel-body">
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label class="control-label" for="input-customer-group">Группа покупателей</label>
                <select name="filter_customer_group" id="input-customer-group" class="form-control">
                  <option value="*"></option>
                  <?php if ($filter_customer_group == '2') { ?>
                    <option value="2" selected="selected">Опт</option>  
                  <? } else { ?>
                  <option value="2">Опт</option>
                  <? } ?>
                  <?php if ($filter_customer_group == '1') { ?>
                    <option value="1" selected="selected">Розница</option>  
                  <? } else { ?>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left">Опт/Розница</td> 
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <?php if ($order['customer_group_id'] == '1') { ?>
                  <td class="text-left">Розница</td>
                  <?php } else { ?>
                  <td class="text-left">Оптовики</td>
                  <?php } ?>
