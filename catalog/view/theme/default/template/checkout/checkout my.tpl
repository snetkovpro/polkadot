            ...
            <form method="POST" name="checkout">
                <div class="row">
                    <div class="panel panel-default">
                     ...
                     <div class="panel" id="collapse-checkout-confirm">
                    ...
                    <div>
                        <h3>Доставка</h3>
                        <select class="form-control" name="tk" size="1">
                            <option selected>Выберите ТК</option>
                            <option value="0">ПЭК</option>
                            <option value="1">СДЭК</option>
                            <option value="2">Желдорэкспедиция</option>
                        </select>
                        <select class="form-control" name="wrap" size="1">
                            <option selected>Выберите доп. упаковку в ТК</option>
                            <option value="0">Без доп. упаковки</option>
                            <option value="1">Жёсткая упаковка</option>
                            <option value="2">Палённый борт</option>
                        </select>
                        <input class="form-control" type="checkbox" name="teplom">
                        <input type="text" class="form-control" name="tkcost">
                        <h3>Оплата</h3>
                        <input type="radio" class="form-control" name="payment" value="rs">Расчётный счёт
                        <input type="radio" class="form-control" name="payment" value="card">Карта Сбербанка
                    ...
                    <?php } else { ?>
                        <div>
                        <h3>Доставка</h3>
                            <label class="radio-inline"><input type="radio" name="delivery" value="0">Самовывоз</label>
                            <label class="radio-inline"><input type="radio" name="delivery" value="1">Курьер по СПб</label>
                            <label class="radio-inline"><input type="radio" name="delivery" value="2">Почта РФ</label>
                            <label class="radio-inline"><input type="radio" name="delivery" value="3">Почта РФ (1класс)</label>
                            <label class="radio-inline"><input type="radio" name="delivery" value="4">Почта РФ (по миру)</label>
                            <h3>Оплата</h3>
                            <label class="radio-inline"><input type="radio" name="payment" value="0">Банковская карта</label>
                            <label class="radio-inline"><input type="radio" name="payment" value="1">Карта Сбербанка</label>
                            <label class="radio-inline"><input type="radio" name="payment" value="2">Qiwi-кошелек</label>
                            <label class="radio-inline"><input type="radio" name="payment" value="3">Наличными</label>
