                ...
                <tr>
                    ...
                    <td class="name">
                        ...
                        <?php if (!$product['stock'] && ($config_stock_warning || !$config_stock_checkout)) { ?>
                                ...
                                <a style="color:red;" href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
                                <span style="color:red;" class="product-warning">***</span>
                    ...
                    <td class="quantity">
                        <div class="input-group btn-block" style="max-width: 200px;">
                            ...
                            <input class="form-control" type="text" data-onchange="changeProductQuantity" name="quantity[<?php echo !empty($product['cart_id']) ? $product['cart_id'] : $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" disabled />
...
<?php } ?>
<?php if (isset($modules['coupon']) && $guest) { ?>
