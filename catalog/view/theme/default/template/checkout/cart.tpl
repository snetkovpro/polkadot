          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <td class="text-left"><?php echo $column_pack; ?></td>
                <td class="text-right"><?php echo $column_price; ?></td>
                <td class="text-right"><?php echo $column_pack_price; ?></td>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-left"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
                  ...
                  <br> Осталось <?php echo $product['stock_quantity']; ?> товаров на складе.
                  <?php } ?>
                ...
                <td class="text-left">
                   <b> <?php echo $product['pack']; ?></b> в упаковке
                </td>
                 <td class="text-left">
