...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($this->customer->isLogged()) {
		    ...
		    $minQuantity = $this->model_catalog_product->getMinQuantity($product_id, $customer_group_id);
		    $minimum = $customer_group_id ? $minQuantity : 1; //#roma
		} else {
		    $minimum = 1;
		}
		...
		if ($product_info) {
			...
			$pack = $this->model_catalog_product->getPack($product_id) ? $this->model_catalog_product->getPack($product_id)['pack'] : 0; //#roma
