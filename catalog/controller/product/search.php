	...
	public function index() {
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			foreach ($results as $result) {
				...
				$register = isset($this->session->data['customer_id']) ? 1 : 0;
				$minimum = $register ? $this->model_catalog_product->getMinQuantity($result['product_id'])['min_quantity'] : $this->model_catalog_product->getMinQuantity($result['product_id'])['retail'];
				$pack = $register ? $this->model_catalog_product->getPack($result['product_id'])['pack'] : $this->model_catalog_product->getPack($result['product_id'])['retail'];
				$discount = $register ? (($prices['wholesale_discount'] != 0) ? 100-$prices['wholesale_discount']*100/$prices['wholesale'] : 0) : (($prices['retail_discount'] != 0) ? 100-$prices['retail_discount']*100/$prices['retail'] : 0);
