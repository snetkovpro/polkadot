	...
	public function index() {
		...
		if ($category_info) {
			...
			foreach ($results as $result) {
				...
				$minimum = $customer_group_id ? implode($this->model_catalog_product->getMinQuantity($result['product_id'], $customer_group_id)) : 0; //#roma
				$pack = $this->model_catalog_product->getPack($result['product_id']) ? $this->model_catalog_product->getPack($result['product_id'])['pack'] : 0;
				$data['opt'] = $customer_group_id;
