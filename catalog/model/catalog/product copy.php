...
class ModelCatalogProduct extends Model {
	...
	public function getMinQuantity($product_id, $customer_id) {
	   
	    $query = $this->db->query("SELECT min_quantity FROM " . DB_PREFIX . "product_to_min_quantity WHERE product_id = '" . (int)$product_id . "' AND customer_id = '" . (int)$customer_id . "'");
	    return $query->row;
	...
	//Функция получения данных об упаковке
	    ...
	    $query = $this->db->query("SELECT pack FROM " . DB_PREFIX . "product_to_pack WHERE product_id = '" . (int)$product_id . "'");
	    return $query->row;
