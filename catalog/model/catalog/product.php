...
class ModelCatalogProduct extends Model {
	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			return array(
				...
				'guest_status'     => $query->row['guest_status'],
	...
	//Функция выборки минимального количества для заданного кастомера
	...
	//Функция получения данных об упаковке
	...
	//specials
	public function getProductSpecials2($product_id) {
	...
	public function getCartProduct($cart_id) {
		$query = $this->db->query("SELECT product_id FROM " . DB_PREFIX . "cart WHERE cart_id = '" . (int)$cart_id . "'");
